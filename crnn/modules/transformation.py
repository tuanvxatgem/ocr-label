...
class TPSSpatialTransformerNetwork(nn.Module):
    ...
    def __init__(self, F, I_size, I_r_size, I_channel_num=1):
        ...
        image_input:
            ...
            I_size : (height, width) of the image_input image I
            I_r_size : (height, width) of the rectified image I_r
            I_channel_num : the number of channels of the image_input image I
        output:
...
class LocalizationNetwork(nn.Module):
    ...
    def forward(self, batch_I):
        """
        image_input:     batch_I : Batch Input Image [batch_size x I_channel_num x I_height x I_width]
        output:    batch_C_prime : Predicted coordinates of fiducial points for image_input batch [batch_size x F x 2]
        """
