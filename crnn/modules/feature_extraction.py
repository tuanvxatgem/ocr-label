...
class ResNetFeatureExtractor(nn.Module):
    ...
    (https://openaccess.thecvf.com/content_ICCV_2017/papers/Cheng_Focusing_Attention_Towards_ICCV_2017_paper.pdf) """
...
class GRCL(nn.Module):
    ...
    def forward(self, input):
        """ The image_input of GRCL is consistant over time t, which is denoted by u(0)
