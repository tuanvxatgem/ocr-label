...
from modules.feature_extraction import VGGFeatureExtractor, RCNNFeatureExtractor, ResNetFeatureExtractor
...
class Model(nn.Module):
    ...
    def __init__(self, opt):
        ...
        if opt.FeatureExtraction == 'VGG':
            ...
            self.FeatureExtraction = RCNNFeatureExtractor(opt.input_channel, opt.output_channel)
    ...
    def forward(self, image_input, text, is_train=True):
        """ Transformation stage """
        # if not self.stages['Trans'] == "None":
        #     image_input = self.Transformation(image_input)
        """ Feature extraction stage """
        visual_feature = self.FeatureExtraction(image_input)
